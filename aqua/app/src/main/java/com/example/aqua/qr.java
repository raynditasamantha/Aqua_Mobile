...
public class qr extends AppCompatActivity {
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(qr.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(qr.this, new
    ...
    public void submit(View v) {
        Intent intent = new Intent(qr.this, red.class);
        startActivity(intent);
    }

    public void cancel(View v) {
        Intent intent = new Intent (qr.this, hal1.class);
        startActivity(intent);}
